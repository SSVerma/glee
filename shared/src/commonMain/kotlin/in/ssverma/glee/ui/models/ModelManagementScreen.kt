...
package `in`.ssverma.glee.ui.models
...
fun ModelManagementScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                text = "Manage the models on your device and run benchmark on their performances.",
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            Row(
                ...
                Column {
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        Icon(Icons.Default.DownloadForOffline, null, modifier = Modifier.size(14.dp), tint = MaterialTheme.colorScheme.primary)
                        Spacer(Modifier.width(4.dp))
                        Text(text = "${model.sizeGb} GB", style = MaterialTheme.typography.labelSmall)
                    }
                }
            ...
            Surface(
                ...
                Column(modifier = Modifier.padding(12.dp)) {
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        Icon(Icons.Default.Memory, null, modifier = Modifier.size(14.dp), tint = MaterialTheme.colorScheme.primary)
                        Spacer(Modifier.width(8.dp))
                        Text(
            ...
            when (val status = model.downloadStatus) {
                ...
                is ModelDownloadStatus.Error -> {
                    Column {
                        Text(text = status.message, color = MaterialTheme.colorScheme.error, style = MaterialTheme.typography.labelSmall)
                        Button(onClick = onDownload, modifier = Modifier.fillMaxWidth()) { Text(stringResource(Res.string.retry)) }
                    }
                }
            }
        }
