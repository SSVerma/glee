...
class JsGleeDatabase : GleeDatabase() {
...
class JsObservableSettings : ObservableSettings {
...
actual val platformModule: Module = module {
    ...
    single<GleeDatabase> { JsGleeDatabase() }
    single<ObservableSettings> { JsObservableSettings() }
}
